...
ADD COLUMN     "talpOther" TEXT,
ADD COLUMN     "talpParticipation" BOOLEAN,
ADD COLUMN     "talpType" TEXT,
...
ADD COLUMN     "type" "RegistrationType";
